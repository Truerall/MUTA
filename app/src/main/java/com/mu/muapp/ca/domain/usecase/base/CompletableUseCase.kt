...
package com.mu.muapp.ca.domain.usecase.base

import com.mu.muapp.utils.rx.EmptyCompletableObserver
 ...
 *
 * @param scheduler define execution scheduler in implementation of UseCase
 * @param postExecutionScheduler defile result delivery scheduler in implementation of UseCase
 *
 * @see Completable
 */
...
) : BaseReactiveUseCase(scheduler, postExecutionScheduler) {
